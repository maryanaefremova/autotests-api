...
from clients.exercises.exercises_schema import CreateExerciseRequestSchema, CreateExerciseResponseSchema, GetExerciseResponseSchema, GetExercisesQuerySchema, UpdateExerciseRequestSchema, UpdateExerciseResponseSchema, GetExercisesResponseSchema
from fixtures.courses import CourseFixture
from fixtures.exercises import ExcersiceFixture
...
class TestExercises:
    ...
    @allure.severity(Severity.BLOCKER)
    def test_get_exercise(self, exercises_client: ExercisesClient, function_exercise: ExcersiceFixture):
    ...
    def test_update_exercise(self, exercises_client: ExercisesClient, function_exercise: ExcersiceFixture):
    ...
    @allure.severity(Severity.CRITICAL)
    def test_delete_exercise(self, exercises_client: ExercisesClient, function_exercise: ExcersiceFixture):
    ...
    def test_get_exercises(
            ...
            function_exercise: ExcersiceFixture,
